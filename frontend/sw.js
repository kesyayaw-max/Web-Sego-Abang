// RM. Sego Abang Pendopo Wonomarto — Service Worker v1.3
// Strategi: Cache First untuk aset statis, Network First untuk API.

const CACHE_NAME = 'sego-abang-v1.3';
const STATIC_CACHE = 'sego-abang-static-v1.3';
const API_CACHE = 'sego-abang-api-v1.3';
